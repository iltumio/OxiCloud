...
export async function fetchContent(folderId: string | null): Promise<FileItem[]> {
...
export const createUserQuery = () => createQuery({
    queryKey: queryKeys.user,
    queryFn: fetchUser
});

export const createFilesQuery = (folderId: string | null | (() => string | null)) => createQuery(() => {
...
export const createSearchQuery = (query: string | (() => string)) => createQuery(() => {
